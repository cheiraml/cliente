...
public class GameController : MonoBehaviour
{
    ...
    internal void StartGame(GameState state)
    {
        ...
        InputController._Instance.Disparo += (Posiciondireccion) => { Socket.Emit("disparo", Posiciondireccion); };
        State = state;
    ...
    private void InstantiatePlayer(Player player)
    {
        ...
        GamePlayer gamePlaye = playerGameObject.GetComponent<GamePlayer>();
        gamePlaye.Punta = playerGameObject.transform.GetChild(0).gameObject;
        ...
        if (player.Username == NetworkController._Instance.Username) InputController._Instance.jugador = gamePlaye;
    }
